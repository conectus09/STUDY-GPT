...
export function SiteFooter() {
  return (
    <footer className="site-footer relative z-10 mt-auto">
      ...
      <div className="site-footer-inner mx-auto max-w-5xl px-6 py-6 sm:px-10">
        <div className="flex flex-col items-center gap-5 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex flex-col items-center text-center sm:items-start sm:text-left">
            <Logo size="sm" nameClassName="text-sm tracking-[0.14em]" />
            <p className="mt-2 max-w-[220px] text-xs leading-relaxed text-muted">
              {APP_TAGLINE}
            </p>
          </div>

          <nav aria-label="Footer links" className="flex flex-col items-center gap-2">
            <ul className="site-footer-link-row">
        ...
        <p className="site-footer-copy mt-5 text-center text-[11px] text-muted">
